...
(async () => {
  ...
  console.log('[4] 内容新鲜度');
  const markers = [
    ['/', ['<b>19</b> 套', '914'], ['435', '427', '355', '348', '333', '325', '317', '701', '694', '704', '713', '771', '825', '858', '912']],
    ['/preview.html', ['914', '非安全上下文', 'checkdeploy.test.cjs', 'icons.test.js', 'imagecompose.test.cjs', 'SSE4.2', 'ui-status.test.cjs', 'ui-firstrun.test.cjs', 'ui-tags.test.cjs', 'zipbackup.test.js', 'status.test.js', 'status-board-dark.png'], ['435', '427', '355', '348', '333', '325', '317', '701', '694', '704', '713', '771', '825', '858', '912']],
    ['/docs/fnos-deploy-guide.html', ['导入自己刚导出的备份', '重建容器时要不要清空这个目录', '确认新代码真的生效', 'ghcr.io'], []],
    ['/docs/docker-guide.html', ['关于「完整性校验失败」', '914', '19 个套件', 'check-deploy.cjs', 'docker-compose.image.yml', 'SSE4.2', '服务发现（伪造 Docker API） 99 项', '主界面 UI  103 项', '首次引导 / 拖链接建卡 UI    33 项', '卡片标签 / 跨分组检索 UI    40 项', '服务端集成  50 项', '状态板 UI   32 项'], ['435', '427', '355', '348', '333', '325', '701', '694', '704', '713', '771', '825', '858', '912', '825 项断言 / 17 个套件', '服务发现（伪造 Docker API） 80 项', '主界面 UI  27 项', '服务端集成  48 项', '服务端集成  36 项', '服务端集成 24 项', '备份 UI    16 项', '备份恢复 / 图片魔数校验     22 项', '备份恢复 / 图片魔数校验     20 项', '图床库（引用保护 / 批量上传）40 项', '服务发现 UI                36 项']],
