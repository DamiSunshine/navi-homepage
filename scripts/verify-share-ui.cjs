...
(async () => {
  ...
  console.log('[4] 内容新鲜度');
  const markers = [
    ['/', ['<b>16</b> 套', '713'], ['435', '427', '355', '348', '333', '325', '317', '701', '694', '704']],
    ['/preview.html', ['713', '非安全上下文', 'checkdeploy.test.cjs', 'imagecompose.test.cjs', 'SSE4.2', 'ui-status.test.cjs', 'zipbackup.test.js', 'status.test.js', 'status-board-dark.png'], ['435', '427', '355', '348', '333', '325', '317', '701', '694', '704']],
    ['/docs/fnos-deploy-guide.html', ['导入自己刚导出的备份', '重建容器时要不要清空这个目录', '确认新代码真的生效', 'ghcr.io'], []],
    ['/docs/docker-guide.html', ['关于「完整性校验失败」', '713', 'check-deploy.cjs', 'docker-compose.image.yml', 'SSE4.2'], ['435', '427', '355', '348', '333', '325', '701', '694', '704']],
